...
User.delete_all
# User #1 - Super User:
User.create!(full_name: "Sample User", display_name: "User#1", email: "user@example.com", password: "12345678",password_confirmation:"12345678", date_of_birth: DateTime.strptime('09/14/2009', '%m/%d/%Y'), gender: "male", is_admin: true, is_super_user: true, facebook_url: "fdf", personal_message: "sample personal message", twitter_url: "https://twitter.com/Deovandski", webpage_url: "www.google.com", privacy_terms_read: true, legal_terms_read: true)
# User #2 - Admin User:
User.create!(full_name: "User Example", email: "user@sample.com", display_name: "User#2", password: "12345678",password_confirmation:"12345678",date_of_birth: DateTime.strptime('09/14/2009', '%m/%d/%Y'), gender: "female",  is_admin: true, is_super_user: false,facebook_url: "gfds", personal_message: "Vocaloid Rules!", twitter_url: "https://twitter.com/Deo", webpage_url: "www.deovandski.blogspot.com", privacy_terms_read: true, legal_terms_read: true)
# User #3 - Normal User:
User.create!(full_name: "User", email: "test@test.com", display_name: "User#3", password: "12345678", password_confirmation:"12345678", date_of_birth: DateTime.strptime('09/14/2009', '%m/%d/%Y'), gender: "male",  is_admin: false, is_super_user: false,facebook_url: "hgfdsh", personal_message: "Vocaloid Rules!", twitter_url: "https://twitter.com/Deo", webpage_url: "www.deovandski.blogspot.com", privacy_terms_read: true, legal_terms_read: true)
